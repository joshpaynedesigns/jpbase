...
if ( ! function_exists('mktg434_staff_cpt') ) {

// Register Custom Post Type
function mktg434_staff_cpt() {
...
add_action( 'init', 'mktg434_staff_cpt', 0 );

}


// Rename the title text on creating a new post
function mktg434_change_staff_member_title( $title ){
...
add_filter( 'enter_title_here', 'mktg434_change_staff_member_title' );
