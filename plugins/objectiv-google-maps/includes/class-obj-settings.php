	...
	private function settings_fields() {
		...
		$settings['general'] = array(
			...
			'fields'      => array(
				...
				array(
					'id'          => 'api_key_geocode',
					'label'       => __( 'Google API Key (Geocoding)', 'obj-google-maps' ),
					'description' => __( 'Enter an optional second Google API key just for Geocoding', 'obj-google-maps' ),
					'type'        => 'text',
					'default'     => '',
					'placeholder' => __( 'Google API Key (Optional, first one used if empty)', 'obj-google-maps' ),
					'class'       => 'regular-text',
					'callback'    => 'wp_strip_all_tags',
				),
			),
