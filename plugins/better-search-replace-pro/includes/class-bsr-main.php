...
class Better_Search_Replace {
	...
	private function define_admin_hooks() {
		...
		// Other admin actions.
		$this->loader->add_action( 'admin_post_bsr_process_load_profile', $plugin_admin, 'process_load_profile' );
		$this->loader->add_action( 'admin_post_bsr_process_delete_profile', $plugin_admin, 'process_delete_profile' );
		...
		$this->loader->add_action( 'admin_post_bsr_download_backup', $plugin_admin, 'download_backup' );
		$this->loader->add_action( 'load-tools_page_better-search-replace', $plugin_admin, 'upgrade_profiles' );

		// Licensing actions.
		$this->loader->add_action( 'admin_init', $plugin_admin, 'updater' );
		...
		$this->loader->add_action( 'admin_init', $plugin_admin, 'upgrade_routine' );
