...
if (! function_exists('ns_projects_cpt')) {
// Register Custom Post Type
    function ns_projects_cpt()
    {
    ...
    add_action('init', 'ns_projects_cpt', 0);
}


// Rename the title text on creating a new post
function ns_change_projects_member_title($title)
{
...
add_filter('enter_title_here', 'ns_change_projects_member_title');
