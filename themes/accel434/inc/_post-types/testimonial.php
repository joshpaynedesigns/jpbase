...
if ( ! function_exists('mktg434_testimonial_cpt') ) {

// Register Custom Post Type
function mktg434_testimonial_cpt() {
...
add_action( 'init', 'mktg434_testimonial_cpt', 0 );

}


// Rename the title text on creating a new post
function mktg434_change_testimonial_title( $title ){
